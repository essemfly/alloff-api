...
func AddMockHomeTabs() {
	...
	exhibitions, _, _ := ioc.Repo.Exhibitions.List(0, 10, true, domain.EXHIBITION_NORMAL, "")
...
func AddMockTopBanners() {
	...
	exhibitions, _, _ := ioc.Repo.Exhibitions.List(0, 5, true, domain.EXHIBITION_NORMAL, "")
